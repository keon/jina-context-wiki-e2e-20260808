  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Coverage",
        body: [
          "Check whether history coverage is complete or bounded. A bounded release is useful, but it does not claim that commits outside the analyzed range were considered."
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        body: [
          "Depending on your plan and deployment, reviews can use managed credits, an organization OpenRouter key, or a connected ChatGPT subscription."
        ],
        bullets: [
      ...
      },
      {
        ...
        body: [
          "Planner, replanner, investigation, and review stages can have different model and reasoning-effort settings. Start with the defaults, then change one stage at a time and compare review quality, latency, and cost."
        ]
      },
      {
        heading: "Failure behavior",
        body: [
          "Use Models to choose whether a provider failure should use an allowed fallback or fail and notify. A silent provider substitution makes quality and billing harder to reason about, so Jina records the effective route on the run."
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        body: [
          "A Clerk organization is Jina's ownership boundary for GitHub connections, repositories, generated context, model settings, usage, and billing. It remains distinct from any GitHub organization you connect."
        ]
      },
      {
        heading: "Roles",
      ...
      },
      {
        ...
        body: [
          "Check the organization switcher at the top of the sidebar before installing GitHub, changing models, starting a Context build, or viewing billing. Every page is scoped to the selected organization."
        ]
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Refresh Integrations, verify the GitHub App’s repository selection, and confirm you are viewing the Jina organization that owns the installation. Reconnecting is rarely the first fix."
        ]
      },
      {
        heading: "Context looks stale",
        body: [
          "Compare the published release commit with the repository default branch. Start a new Context build if the release predates meaningful changes, and inspect checkpoint status if publication does not complete."
        ]
      },
      {
