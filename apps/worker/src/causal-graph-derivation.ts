...
export function issueGraphPrompt(
  ...
  return [
    ...
    `For at least ${Math.min(3, minimumIssues)} issues, search backward from the repair or symptom and cite the earlier commit that introduced the behavior with role introduced. Do not relabel a repair as introduced.`,
