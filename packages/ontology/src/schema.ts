    ...
    edges: {
      ...
      items: {
        ...
        properties: {
          source: { type: "string" },
          target: { type: "string" },
          predicate: { type: "string", enum: ["IMPLEMENTS", "DOCUMENTED_BY", "REFERENCES", "OWNED_BY", "MOVED_FROM", "LIKELY_AFFECTS"] },
...
- Knowledge-plane predicates describe meaning. Use only IMPLEMENTS, DOCUMENTED_BY, REFERENCES, OWNED_BY, MOVED_FROM, or LIKELY_AFFECTS; unsupported predicates are retained in raw model provenance but rejected as assertions.
...
- Use only IMPLEMENTS, DOCUMENTED_BY, REFERENCES, OWNED_BY, MOVED_FROM, or LIKELY_AFFECTS.
